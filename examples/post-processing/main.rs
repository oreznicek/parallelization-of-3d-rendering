...
use std::path::Path;
use std::borrow::Cow;
use effects::{ AllowedEffects, UVVertex };
...
impl framework::Example for Example {
    fn init(
        ...
        let flags = AllowedEffects::TINT | AllowedEffects::CONTOUR;
    ...
    fn render(
        ...
        //self.post_processing.resolve(device, queue, &self.output_view, view);
